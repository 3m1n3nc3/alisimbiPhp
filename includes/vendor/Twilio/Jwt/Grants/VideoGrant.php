...
class VideoGrant implements Grant {
    ...
    private $SETTigurationProfileSid;
    private $room;
     ...
     *
     * @param string $SETTigurationProfileSid configuration profile sid of grant
     *
     * @return $this updated grant
     */
    public function setConfigurationProfileSid($SETTigurationProfileSid) {
        trigger_error('Configuration profile sid is deprecated, use room instead.', E_USER_NOTICE);
        $this->configurationProfileSid = $SETTigurationProfileSid;
        return $this;
    }
