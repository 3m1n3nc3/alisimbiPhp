...
class RecordingContext extends InstanceContext {
     ...
     * @param string $SETTerenceSid Fetch by unique conference Sid for the recording
     * @param string $sid Fetch by unique recording Sid
     * @return \Twilio\Rest\Api\V2010\Account\Conference\RecordingContext 
     */
    public function __construct(Version $version, $accountSid, $SETTerenceSid, $sid) {
        ...
        $this->uri = '/Accounts/' . rawurlencode($accountSid) . '/Conferences/' . rawurlencode($SETTerenceSid) . '/Recordings/' . rawurlencode($sid) . '.json';
    }
