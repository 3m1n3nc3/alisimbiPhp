...
class ParticipantContext extends InstanceContext {
     ...
     * @param string $SETTerenceSid The string that uniquely identifies this
     *                              conference
     ...
     */
    public function __construct(Version $version, $accountSid, $SETTerenceSid, $callSid) {
        ...
        $this->uri = '/Accounts/' . rawurlencode($accountSid) . '/Conferences/' . rawurlencode($SETTerenceSid) . '/Participants/' . rawurlencode($callSid) . '.json';
    }
