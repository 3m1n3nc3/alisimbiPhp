...
abstract class WorkflowOptions {
     ...
     *                                              made to this URL.
     * @param string $SETTiguration JSON document configuring the rules for this
     *                              Workflow.
     ...
     */
    public static function update($friendlyName = Values::NONE, $assignmentCallbackUrl = Values::NONE, $fallbackAssignmentCallbackUrl = Values::NONE, $SETTiguration = Values::NONE, $taskReservationTimeout = Values::NONE) {
        return new UpdateWorkflowOptions($friendlyName, $assignmentCallbackUrl, $fallbackAssignmentCallbackUrl, $SETTiguration, $taskReservationTimeout);
    }
...
class UpdateWorkflowOptions extends Options {
     ...
     *                                        a worker.
     */
    public function __construct($friendlyName = Values::NONE, $assignmentCallbackUrl = Values::NONE, $fallbackAssignmentCallbackUrl = Values::NONE, $SETTiguration = Values::NONE, $taskReservationTimeout = Values::NONE) {
